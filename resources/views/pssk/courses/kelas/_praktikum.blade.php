            ...
            <div class="table-responsive">
                <table class="compact-table table-bordered">
                    ...
                    <tbody id="schedule-tbody">
                        ...
                        ->groupBy(function ($item) {return strtolower($item->topic ?? '');})
                        ->sortKeys();
                        @endphp
                        ...
                        <tr class="collapse show schedule-row" id="topic-{{ Str::slug($topic) }}"
                            ...
                            {{-- contoh kode kelas --}}
                            <td class="text-center fw-semibold">
                                {{ $schedule->class_code ?? strtoupper(substr($schedule->activity->code ?? 'PR', 0, 2))
                            ...
                            <td class="soft-info">
                                <input type="text" name="schedules[{{ $schedule->id }}][topic]"
                                    class="form-control text-center input-bg topic-input" value="{{ $schedule->topic }}"
