...
@include('pssk.courses.kelas._kuliah', ['schedules' => $schedules])
@elseif ($activityName === 'PEMICU')
@include('pssk.courses.kelas._pemicu', ['schedules' => $schedules])
@elseif ($activityName === 'PRAKTIKUM')
@include('pssk.courses.kelas._praktikum', ['schedules' => $schedules])
@elseif ($activityName === 'SKILL LAB')
@include('pssk.courses.kelas._skilllab', ['schedules' => $schedules])
@elseif ($activityName === 'UJIAN TEORI')
@include('pssk.courses.kelas._ujian_teori', ['schedules' => $schedules])
@elseif ($activityName === 'PLENO')
@include('pssk.courses.kelas._pleno', ['schedules' => $schedules])
@endif
@endforeach