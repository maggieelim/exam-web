  ...
  <div class="col-12 mb-4">
    <div class="card">
      <div class="card-header pb-0 d-flex justify-content-between align-items-center">
        ...
        <div>
          <a href="{{ route('admin.semester.index') }}" class="btn btn-sm btn-secondary me-2">Kembali</a>
      ...
      <div class="card-body px-4 pt-3 pb-3">
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" value="{{ $semester->academicYear->year_name }}" readonly>
          </div>
          <div class="col-md-4 mb-3">
            <label class="form-label">Tanggal Mulai Tahun Akademik</label>
            <input type="date" class="form-control" value="{{ $semester->academicYear->start_date }}" readonly>
          </div>
          <div class="col-md-4 mb-3">
            <label class="form-label">Tanggal Berakhir Tahun Akademik</label>
            <input type="date" class="form-control" value="{{ $semester->academicYear->end_date }}" readonly>
          </div>
        </div>
        ...
        <div class="row mb-3">
          <div class="col-md-6 mb-3">
            ...
            <input type="text" class="form-control"
              value="{{ $semester->created_at ? $semester->created_at->format('d M Y H:i') : '-' }}" readonly>
          </div>
          <div class="col-md-6 mb-3">
            <label class="form-label">Terakhir Diperbarui</label>
            <input type="text" class="form-control"
              value="{{ $semester->updated_at ? $semester->updated_at->format('d M Y H:i') : '-' }}" readonly>
          </div>
        </div>
      </div>
    </div>
