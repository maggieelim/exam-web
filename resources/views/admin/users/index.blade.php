                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    @elseif ($type === 'lecturer')
                                        {{-- Kolom NIDN untuk dosen --}}
                                        <th class="text-center text-uppercase text-dark text-sm font-weight-bolder">

                                            <a
                                                href="{{ route('admin.users.index', array_merge(['type' => $type, 'sort' => 'nidn', 'dir' => request('dir') === 'asc' ? 'desc' : 'asc'], $filters)) }}">
                                                NIDN
                                    ...
                                    <tr>
                                        ...
                                        @if ($user->hasRole('student'))
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-sm font-weight-bold">{{ $user->student->nim ?? '-' }}</span>
                                            </td>
                                        @elseif($user->hasRole('lecturer'))
                                            <td class="align-middle text-center">
                                                <span
                                                    class="text-sm font-weight-bold">{{ $user->lecturer->nidn ?? '-' }}</span>
                                            </td>
                                        @endif
