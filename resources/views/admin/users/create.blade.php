...
<div class="row">
  ...
  <div class="col-12 mb-4">
    <div class="card">
      ...
      <div class="card-body px-4 pt-2 pb-2">
        <form method="POST" action="{{ route(session('context').'.admin.users.import', $type) }}"
          ...
          <div class="row align-items-end">
            ...
            <div class="col-md-2 mb-3">
              <a href="{{ route(session('context').'.admin.users.download-template', $type) }}"
  ...
  <div class="col-12 mb-4">
    <div class="card">
      ...
      <div class="card-body px-4 pt-2 pb-2">
        <form method="POST" action="{{ route(session('context').'.admin.users.store', $type) }}">
          @csrf
