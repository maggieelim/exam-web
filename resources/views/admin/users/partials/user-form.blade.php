...
$genderValue = $user->student->gender;
} elseif ($type === 'lecturer' && $user->lecturer) {
$genderValue = $user->lecturer->gender;
}
}
@endphp
...
<div class="row g-3 mb-3">
  ...
  @if($type === 'student')
  @include('admin.users.partials.student-fields', ['student' => $user->student ?? null, 'isCreate' => $isCreate])
  @elseif($type === 'lecturer')
  @include('admin.users.partials.lecturer-fields', ['lecturer' => $user->lecturer ?? null, 'isCreate' => $isCreate])
  @endif
</div>
