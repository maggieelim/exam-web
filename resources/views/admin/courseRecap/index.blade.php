...
<div>
    <div class="d-flex flex-wrap justify-content-start justify-content-md-end gap-2 mt-2 mt-md-0">
        <a class="btn px-3 py-2 bg-gradient-success"
            href="{{ route('admin.lecturer-recap.download', request()->query()) }}">
    ...
    <div class="mb-3 card collapse" id="filterCollapse">
                ...
                <div class="row g-2">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="sesi" class="form-select">
                            ...
                            @foreach ($sesi as $s)
                            <option value="{{ $s }}" {{request('sesi')==$s ? 'selected' :''}}>
                                {{ $s }}
                            </option>
                            @endforeach
                        </select>
