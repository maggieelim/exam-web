    ...
    <div class="col-12">
        <div class="card mb-4">
            <div
                ...
                <div>
                    <h5 class="mb-0">List Rumah Sakit</h5>
                </div>
            ...
            <div class="collapse" id="filterCollapse">
                <form method="GET" action="{{ route('rumah-sakit.index') }}">
                    <div class="mx-3 my-2 py-2">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-12 d-flex justify-content-end gap-2 mt-2">
                                <a href="{{ route('rumah-sakit.index') }}" class="btn btn-light btn-sm">Reset</a>
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <div class="table-responsive p-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="{{ route('rumah-sakit.edit', $hospital->id) }}"
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <x-pagination :paginator="$hospitals" />
                    </div>
                </div>
            </div>
        </div>
