        ...
        <div class="card mb-4">
            <div
                ...
                <div class="d-flex flex-column flex-md-row align-items-md-center gap-2">
                    <h5 class="mb-0">List Kepaniteraan</h5>
                    @if ($semesterId)
                    @php
                ...
                <div class="d-flex flex-wrap justify-content-start justify-content-md-end gap-2 mt-2 mt-md-0">
                    ...
                    <a href="{{ route('kepaniteraan.create') }}" class="btn btn-primary btn-sm"
                    ...
                    <div class="mx-3 my-2 py-2">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-12 d-flex justify-content-end gap-2 mt-2">
                                <a href="{{ route('kepaniteraan.index') }}" class="btn btn-light btn-sm">Reset</a>
