                ...
                <tbody>
                    @foreach ($schedules as $index => $schedule)
                        <tr>
                            ...
                            @endif
                            <td class="text-center fw-semibold">
                                {{ $schedule->class_code ?? strtoupper(substr($schedule->activity->code ?? 'UT', 0, 2)) . sprintf($schedule->session_number) }}
                            </td>
                            ...
                            <td>
                                <input type="text" name="schedules[{{ $schedule->id }}][ruang]"
                                    class="form-control text-center input-bg " value="{{ $schedule->ruang }}">
                            </td>
                        </tr>
                    @endforeach
                </tbody>
