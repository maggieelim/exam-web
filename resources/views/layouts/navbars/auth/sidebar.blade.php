<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-0 fixed-start" id="sidenav-main" style="height: 100vh;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->is('admin/users/student*') ? 'active' : '' }}" href="{{ url('admin/users/student') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-user-graduate {{ request()->is('admin/users/student*') ? 'text-white' : 'text-dark' }}"></i>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->is('admin/users/lecturer*') ? 'active' : '' }}" href="{{ url('admin/users/lecturer') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-chalkboard-teacher {{ request()->is('admin/users/lecturer*') ? 'text-white' : 'text-dark' }}"></i>
          </div>
          <span class="nav-link-text ms-1">Lecturers</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ request()->is('admin/users/admin*') ? 'active' : '' }}" href="{{ url('admin/users/admin') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-user-shield {{ request()->is('admin/users/admin*') ? 'text-white' : 'text-dark' }}"></i>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->is('admin/semester*') ? 'active' : '' }}" href="{{ url('admin/semester') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-calendar {{ request()->is('admin/semester*') ? 'text-white' : 'text-dark' }}"></i>
          </div>
      ...
      <li class="nav-item">
        <a class="nav-link {{ request()->is('student/exams/upcoming') ? 'active' : '' }}" href="{{ url('student/exams/upcoming') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="fas fa-calendar-alt {{ request()->is('student/exams/upcoming') ? 'text-white' : 'text-dark' }}"></i>
          </div>
          <span class="nav-link-text ms-1">Upcoming Exam</span>
        </a>
      </li>
