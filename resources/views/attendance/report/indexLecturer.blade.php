        ...
        <div class="card mb-4">
            <div
                ...
                <div class="d-flex flex-column flex-md-row align-items-md-center gap-2">
                    <h5 class="mb-0">List Pertemuan </h5>
                </div>
            ...
            <div class="collapse" id="filterCollapse">
                <form method="GET" action="{{ route('attendances.reportLecturer') }}">
                    <div class="mx-3 my-2 py-2">
                        <div class="row g-2">
                            ...
                            <div class="col-12 d-flex justify-content-end gap-2 mt-2">
                                <a href="{{ route('attendances.reportLecturer') }}"
                    ...
                    <table class="table align-items-center mb-0 text-wrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center text-sm">
                                    <a href="{{ route('attendances.report.show', ['course' => $attendance->course->slug, 'semester_id' => $attendance->semester_id, 'session' =>$attendance->id]) }}"
