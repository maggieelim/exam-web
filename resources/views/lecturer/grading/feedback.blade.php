                ...
                <div class="col-md-12">
                    ...
                    <select name="answer_status" id="answer_status" class="form-control">
                        ...
                        <option value="incorrect" {{ request('answer_status')=='incorrect' ? 'selected' : '' }}>
                            Incorrect</option>
                        <option value="not_answered" {{ request('answer_status')=='not_answered' ? 'selected' : '' }}>
                            Not Answered</option>
                    </select>
                </div>
...
<form role="form" id="feedbackForm" action="{{ route('lecturer.feedback.update', [
            'exam_code' => $exam->exam_code,
            'nim' => $student->nim,
        ]) }}" method="POST">
    @csrf
    ...
    <div class="card mb-3 shadow-sm">
        <div class="card-body">
            <div class="d-flex flex-column-reverse flex-md-row justify-content-between gap-1">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-12 d-flex justify-content-between align-items-center gap-2">
                ...
                <button type="submit" class="btn btn-primary w-20 m-auto" id="saveButton">
                    ...
                    <span class="d-none d-md-inline ms-1">Save Feedback</span>
                </button>
            </div>
        </div>
