            ...
            <tbody>
              ...
              <tr>
                <td class="align-middle px-3">
                  ...
                  <span class="text-sm">
                    Date Modified: {{ \Carbon\Carbon::parse($exam->updated_at)->format('j/n/y H.i') }} by {{ $exam->updater->name }}
                  </span>
                </td>
                <td class="text-center">
                  <a href="{{ route('lecturer.results.grade', [$exam->exam_code]) }}"
                    class="btn bg-gradient-secondary m-1 p-2 px-3" title="Info">
                    Grade </a>
                  <a href="{{ route('lecturer.results.show', [$exam->exam_code]) }}"
