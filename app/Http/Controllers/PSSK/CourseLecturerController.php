...
class CourseLecturerController extends Controller
{
    ...
    public function edit(string $slug, Request $request)
    {
        ...
        return view('pssk.courses.dosen.add_lecturer', compact('sort', 'dir', 'course', 'lecturers', 'semester', 'semesterId', 'activity', 'assignedLecturers', 'activityId', 'selectedActivity'));
    }
