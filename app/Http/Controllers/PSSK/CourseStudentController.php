...
use App\Http\Controllers\PSSK\GroupController;
...
class CourseStudentController extends Controller
{
    ...
    public function createGroup(string $slug, Request $request)
    {
        ...
        return view('pssk.courses.siswa.group', compact('course', 'studentData', 'semester', 'semesterId', 'jumlahPerKelompok', 'skillslabDetails', 'practicumDetails'));
    }
    ...
    public function createKelompok(string $slug, Request $request)
    {
        ...
        $jumlahPerKelompok = CourseSchedule::where('course_id', $course->id)->where('semester_id', $semesterId)->value('kelompok');
        return view('pssk.courses.siswa.kelompok', compact('course', 'studentData', 'semester', 'semesterId', 'jumlahPerKelompok'));
    }
