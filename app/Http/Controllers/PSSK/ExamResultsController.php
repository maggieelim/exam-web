...
class ExamResultsController extends Controller
{
    ...
    public function show($examCode, Request $request)
    {
        ...
        if ($agent->isMobile()) {
            return view('pssk.grading.show.mobile.index_mobile', compact('activeTab', 'exam', 'rankingPaginator', 'analytics', 'questionAnalysisPaginator', 'optionsAnalysis', 'chartData', 'status', 'sort', 'dir', 'difficultyLevel'));
        }
        return view('pssk.grading.show.index', compact('activeTab', 'exam', 'rankingPaginator', 'analytics', 'questionAnalysisPaginator', 'optionsAnalysis', 'chartData', 'status', 'sort', 'dir', 'difficultyLevel'));
    }
    ...
    public function buildRankingResults($exam, Request $request)
    {
        ...
        $ranking = $exam->attempts->map(function ($attempt) use ($exam) {
            ...
            $totalAnswer = $userAnswers->where('answer', !null)->count();
